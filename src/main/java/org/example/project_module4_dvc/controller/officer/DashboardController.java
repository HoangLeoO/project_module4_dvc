...
public class DashboardController {
    ...
    public DashboardController(IOfficerService officerService, SimpMessagingTemplate messagingTemplate,
    ...
    public String updateDossierStatus(@RequestParam("dossierId") Long id,
        ...
        if (dueDate.isBefore(LocalDateTime.now())) {
            ...
            redirectAttributes.addFlashAttribute("toastMessage", "Ngày hẹn trả không được là ngày trong quá khứ!");
            return "redirect:/officer/dashboard/reception?id=" + id;
        }
    ...
    public String supplementDossierStatus(@RequestParam("id") Long id, @RequestParam("reason") String reason,
