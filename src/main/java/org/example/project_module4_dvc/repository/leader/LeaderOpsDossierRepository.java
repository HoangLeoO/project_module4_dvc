...
public interface LeaderOpsDossierRepository extends JpaRepository<OpsDossier, Long> {
    ...
    long countReceivedInPeriod(@Param("deptId") Long deptId, @Param("startDate") LocalDateTime start, @Param("endDate") LocalDateTime end);
    ...
    long countResolvedInPeriod(@Param("deptId") Long deptId, @Param("startDate") LocalDateTime start, @Param("endDate") LocalDateTime end);
    ...
    long countOnTimeInPeriod(@Param("deptId") Long deptId, @Param("startDate") LocalDateTime start, @Param("endDate") LocalDateTime end);
    ...
    long countRejectedInPeriod(@Param("deptId") Long deptId, @Param("startDate") LocalDateTime start, @Param("endDate") LocalDateTime end);
